            ...
            <li>
                <a href="/BD2026-KELOMPOK3/dosen_dashboard/dosen.php">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M4.26 10.174c-.053-.462.19-1.154.608-1.391L11.75 4.51c.154-.087.32-.133.49-.133s.336.046.49.133l6.879 4.273c.418.237.661.929.608 1.391L19.22 19.12a1.875 1.875 0 0 1-1.86 1.63H6.621a1.875 1.875 0 0 1-1.86-1.63L4.26 10.174Z" />
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a href="/BD2026-KELOMPOK3/anggota_dashboard/anggota.php">
                    <svg class="icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                        stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A4.226 4.226 0 0 0 5.25 4.508V18.75A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M12 3h.008v.008H12V3Z" />
                    </svg>
                    Anggota
                </a>
            </li>
